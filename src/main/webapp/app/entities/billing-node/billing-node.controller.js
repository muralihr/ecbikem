(function() {
    ...
    angular
        .module('ecbikeApp')
        .controller('BillingNodeController', BillingNodeController);

    BillingNodeController.$inject = ['$scope', '$state', 'BillingNode', 'BillingNodeSearch', 'ParseLinks', 'AlertService', 'pagingParams', 'paginationConstants','sharedGeoProperties'];

    function BillingNodeController ($scope, $state, BillingNode, BillingNodeSearch, ParseLinks, AlertService, pagingParams, paginationConstants,sharedGeoProperties) {
        var vm = this;
        vm.loadAll = loadAll;
